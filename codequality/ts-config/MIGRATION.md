...
> Applies to projects moving from `@merkle-open/ts-config` 1.x to 2.0.0-alpha.2 and later.
...
See [CHANGELOG.md](./CHANGELOG.md) for the exact breaking changes in `2.0.0-alpha.2`.
